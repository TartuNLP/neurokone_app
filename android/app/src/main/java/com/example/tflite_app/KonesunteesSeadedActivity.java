...
public class KonesunteesSeadedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVoicesContainer.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                PrefUtil.setVoice(KonesunteesSeadedActivity.this, voice);
    ...
    private class InitTtsAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(KonesunteesSeadedActivity.this, "Valik tehtud!", Toast.LENGTH_SHORT).show();
        }
    };
}
